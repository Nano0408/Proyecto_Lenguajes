...
INSERT INTO TB_USERS (USER_ID,  NAME_USERS, EMAIL, PASSWORD, Rol) VALUES (101, 1, 'User 1', 'user1@example.com', 'pass1', 'Cliente');
INSERT INTO TB_USERS (USER_ID,  NAME_USERS, EMAIL, PASSWORD, Rol) VALUES (102, 2, 'User 2', 'user2@example.com', 'pass2', 'Cliente');
INSERT INTO TB_USERS (USER_ID,  NAME_USERS, EMAIL, PASSWORD, Rol) VALUES (103, 3, 'User 3', 'user3@example.com', 'pass3', 'Especialista');
INSERT INTO TB_USERS (USER_ID,  NAME_USERS, EMAIL, PASSWORD, Rol) VALUES (104, 4, 'User 4', 'user4@example.com', 'pass4', 'Especialista');
...
INSERT INTO TB_CLIENTES (CLIENTE_ID,  FIRST_NAME, last_name, birthdate,   Provinces) VALUES (2, 2, 'Cliente 2', 'Apellido 2', TO_DATE('1995-05-05', 'YYYY-MM-DD'), 'Padre 2', 'padre2@example.com', '987654321', 102, 2);
INSERT INTO TB_CLIENTES (CLIENTE_ID,  FIRST_NAME, last_name, birthdate,   Provinces) VALUES (1, 1, 'Cliente 1', 'Apellido 1', TO_DATE('2000-01-01', 'YYYY-MM-DD'), 'Padre 1', 'padre1@example.com', '123456789', 101, 1);
INSERT INTO TB_CLIENTES (CLIENTE_ID,  FIRST_NAME, last_name, birthdate,   Provinces) VALUES (3, 3, 'Cliente 3', 'Apellido 3', TO_DATE('1988-10-10', 'YYYY-MM-DD'), 'Padre 3', 'padre3@example.com', '456789012', 103, 3);
INSERT INTO TB_CLIENTES (CLIENTE_ID,  FIRST_NAME, last_name, birthdate,   Provinces) VALUES (4, 4, 'Cliente 4', 'Apellido 4', TO_DATE('1980-12-25', 'YYYY-MM-DD'), 'Padre 4', 'padre4@example.com', '789012345', 104, 4);

-- Inserts para TB_APPOINTMENTS
INSERT INTO TB_APPOINTMENTS (APPOINTMENT_ID,  FECHA, HORA, Provinces) VALUES (1, 1, TO_DATE('2023-11-10', 'YYYY-MM-DD'), '10:00 AM', 1);
INSERT INTO TB_APPOINTMENTS (APPOINTMENT_ID,  FECHA, HORA, Provinces) VALUES (2, 2, TO_DATE('2023-11-12', 'YYYY-MM-DD'), '02:30 PM', 2);
INSERT INTO TB_APPOINTMENTS (APPOINTMENT_ID,  FECHA, HORA, Provinces) VALUES (3, 3, TO_DATE('2023-11-15', 'YYYY-MM-DD'), '11:45 AM', 3);
INSERT INTO TB_APPOINTMENTS (APPOINTMENT_ID,  FECHA, HORA, Provinces) VALUES (4, 4, TO_DATE('2023-11-18', 'YYYY-MM-DD'), '09:00 AM', 4);
